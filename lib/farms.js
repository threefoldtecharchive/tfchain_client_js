...
async function createFarm (self, name, certificationType, countryID, cityID, publicIPs, callback) {
  try {
  ...
  const create = self.api.tx.tfgridModule.createFarm(name, certificationType, countryID, cityID, publicIPs)
