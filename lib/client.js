...
class Client {
  ...
  async setServiceContractMetadata (serviceContractId, metadata, callback) {
    setServiceContractMetadata(this, serviceContractId, metadata, callback)
  }

  async setServiceContractFees (serviceContractId, baseFee, variableFee, callback) {
    setServiceContractFees(this, serviceContractId, baseFee, variableFee, callback)
  }

  async serviceContractApprove (serviceContractId, approve, callback) {
    serviceContractApprove(this, serviceContractId, approve, callback)
  }

  async serviceContractCancel (serviceContractId, callback) {
    serviceContractCancel(this, serviceContractId, callback)
  }

  async serviceContractBill (serviceContractId, variableAmount, metadata, callback) {
    serviceContractBill(this, serviceContractId, variableAmount, metadata, callback)
  }

  async getServiceContract (serviceContractId) {
    getServiceContract(this, serviceContractId)
  }
}
