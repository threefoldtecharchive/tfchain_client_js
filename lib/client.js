...
const { createNameContract, createNodeContract, updateNodeContract, cancelContract, getContract, contractIDByNameRegistration, contractIDByNodeIDAndHash, nodeContracts, createRentContract, activeRentContractForNode } = require('./contract')
...
class Client {
  ...
  async createNodeContract (nodeID, data, deploymentHash, publicIPS, callback) {
    return createNodeContract(this, nodeID, data, deploymentHash, publicIPS, callback)
  }
  ...
  async createRentContract (nodeId, callback) {
    return createRentContract(this, nodeId, callback)
  }
