...
const { createNameContract, createNodeContract, updateNodeContract, cancelContract, getContract, contractIDByNameRegistration, contractIDByNodeIDAndHash, nodeContracts } = require('./contract')
const { tfStoreGet, tfStoreSet, tfStoreRemove } = require('./tfkvstore')
...
class Client {
  ...
  async tfStoreGet(key, callback) {
    return tfStoreGet(this, key, callback)
  }
