...
class Client {
  ...
  async createFarm (name, certificationType, countryID, cityID, publicIPs, callback) {
    return createFarm(this, name, certificationType, countryID, cityID, publicIPs, callback)
  }
