...
const { createTwin, getTwin, getTwinIdByAccountId, deleteTwin, addTwinEntity, deleteTwinEntity, listTwins } = require('./twin')
...
const { createNameContract, createDeployment, updateDeployment, getDeployment, cancelDeployment, cancelContract, getContract, contractIDByNameRegistration, contractIDByNodeIDAndHash, createCapacityReservationContract, updateCapacityReservationContract, activeNodeContracts } = require('./contract')
...
const { createGroup, getGroup, deleteGroup } = require("./group")
const { batch } = require("./utility")
...
class Client {
  ...
  async createDeployment (capacityReservationContractId, hash, data, resources, numberOfPublicIps, callback) {
    return createDeployment(this, capacityReservationContractId, hash, data, resources, numberOfPublicIps, callback)
  }

  async updateDeployment (contractId, hash, data, resources, callback) {
    return updateDeployment(this, contractId, hash, data, resources, callback)
  }

  async getDeployment (id) {
    return getDeployment(this, id)
  }

  async cancelDeployment (deploymentId, callback) {
    return cancelDeployment(this, deploymentId, callback)
  }
  ...
  async createCapacityReservationContract (farmId, CapacityReservationPolicy, solutionProviderId, callback) {
    return createCapacityReservationContract(this, farmId, CapacityReservationPolicy, solutionProviderId, callback)
  }

  async updateCapacityReservationContract (capacityId, resources, callback) {
    return updateCapacityReservationContract(this, capacityId, resources, callback)
  }

  async activeNodeContracts (nodeId) {
    return activeNodeContracts(this, nodeId)
  }
  ...
  async acceptTermsAndConditions (documentLink, documentHash) {
    return acceptTermsAndConditions(this, documentLink, documentHash)
  }
  ...
  async createGroup (callback) {
    return createGroup(this, callback)
  }
  ...
  async deleteGroup (id, callback) {
    return deleteGroup(this, id, callback)
  }
}
