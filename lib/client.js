...
const { vestedTransfer, addTransactionSignature, getTransaction, removeTransaction, reportFailedTransaction, listVestingValidators } = require('./vesting')
const { getBalance } = require('./balance')
const { proposeTransaction, voteTransaction, listBridgeValidators } = require('./voting')
...
class Client {
  ...
  async listBridgeValidators () {
    return listBridgeValidators.bind(this)(this)
  }
  ...
  async reportFailedTransaction (transaction, reason) {
    return reportFailedTransaction.bind(this)(transaction, reason)
  }

  async listVestingValidators () {
    return listVestingValidators.bind(this)(this)
  }
}
