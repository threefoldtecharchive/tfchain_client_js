...
class Client {
  ...
  async createFarm (name, pricingPolicyID, certificationType, countryID, cityID, publicIPs, callback) {
    return createFarm(this, name, pricingPolicyID, certificationType, countryID, cityID, publicIPs, callback)
  }
  ...
  async createNode (farmID, resources, location, countryID, cityID, role, publicConfig, callback) {
    return createNode(this, farmID, resources, location, countryID, cityID, role, publicConfig, callback)
  }

  async updateNode (nodeID, farmID, resources, location, countryID, cityID, role, publicConfig, callback) {
    return updateNode(this, nodeID, farmID, resources, location, countryID, cityID, role, publicConfig, callback)
  }
